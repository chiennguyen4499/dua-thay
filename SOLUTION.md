...
- **Chuyển `tuned_params` + `model_picks_cache` vào bảng key-value trên Turso**: Streamlit Cloud không có đĩa bền nên 2 file JSON này lỗi thời/lệch giữa PC và Cloud; để trong DB thì 2 bên luôn thấy cùng giá trị → mở khoá auto-retune khi có +10–20 trận mới. (Sau refactor trên, tune chạy ~1ph nên auto-retune giờ khả thi.)
