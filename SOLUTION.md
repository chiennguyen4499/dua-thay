...
- **`bet_pair`** = CẶP nên đánh (luật game cho **2 cược/trận**). Cách chọn: (1) **cổng tin cậy** — nhân vật chỉ được nhận nếu GIÁ TRỊ BỘI của nó đã chứng minh +EV chắc: cận dưới CI Wilson của win-rate tầng bội × bội **> 1.05** và tầng ≥10 mẫu. Data hiện tại chỉ **bội 5 & 9** qua cổng; Thầy + bội 10/11/12 + bội 4 (hòa vốn) bị loại → **chặn mô hình đuổi kèo EV-đẹp-trên-giấy** (Thầy bội cao thắng hiếm, thực tế lỗ chuỗi). (2) trong các con "tin cậy", ưu tiên **favorite (bội thấp trước = bội 5 trước 9)**, lấy tối đa 2 — vì data cho thấy cược 2 favorite thắng ~72%, variance thấp. Cặp rỗng → khuyến nghị **bỏ trận** (để vốn trống > cược ép). Mỗi con kèm `stake_fraction` (¼-Kelly, trần 5%).
- **Best value (EV)** (giữ lại cho bảng xếp hạng) = argmax `prob × odds`, kèm khoảng Wilson + Kelly.
